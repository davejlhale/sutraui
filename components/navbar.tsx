  ...
  return (
    <NextUINavbar maxWidth="xl" position="sticky">
      <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
        <NavbarBrand as="li" className="w-40 sm:w-60 md:w-100">
      ...
      <NavbarContent className="hidden sm:flex basis-1/5 sm:basis-full" justify="end">
        <NavbarItem className="hidden sm:flex gap-2">
          <Link isExternal href={siteConfig.sutranovumLinks.twitter} aria-label="Twitter">
            <TwitterIcon className="text-default-500" />
          </Link>
          <Link isExternal href={siteConfig.sutranovumLinks.youtube} aria-label="Youtube">
            <YoutubeIcon className="text-default-500" />
          </Link>
          <Link isExternal href={siteConfig.sutranovumLinks.instagram} aria-label="Instagram">
